...
# This module implements markov chains of first order over the letters in the chain of 'smart' states of the behavioral models.
import persistent
...
class Group_of_Markov_Models_n1(Module, persistent.Persistent):
    ...
    description = 'This module implements markov chains of first order over the \'smart\' states in the chains of states in a LABEL. The states are not just each letter but they follow the meaning in the generation process.' + yellow('Warning') + ', if the original models or labels are deleted, you should fix these models by hand.'
